    ...
    <>
      <div className="view-and-filters">
        <div className={(gridView ? "filters" : "show-filtersSS") + " filters"} >
          <Link href="/" >
            <button type="button" className="reset-filters flex justify-center" title="Réinitialiser" >
        ...
        <div className="">
          <button type="button" onClick={handleFilters} className="reset-filters view flex justify-center align-center">
            ...
            <svg className={gridView ? "none" : "flex"} width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
